...
export const randomDataSchema: SchemaValidation = {
	id: "random-data-schema",
	title: "Random Data Schema Validation",
	description: "Validate the structure and content of the random_data.parquet file against expected schema requirements.",
	filename: "random_data_schema_validation.py",
	expectations: {
		description: "Random dataset should contain numeric columns with reasonable ranges and proper data types",
		columns: {
			"id": {
				type: "int64",
				required: true,
