...
export const advancedAnalysisScript: Script = {
	id: "advanced-analysis",
	title: "Advanced Analysis Report",
	description: "Generate an advanced analysis report using the summary data from the Random Data Summary script.",
	...
	dependencies: [
		...
		{
			type: 'result',
			sourceId: 'data-summary' // Reference the script ID that generates the required result file
		}
	],
